    ...
    public partial class FrmPrincipal : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                btnStartClass.Enabled = false;
            }catch(NullReferenceException ex)
            {
                MessageBox.Show("Camera is not working properly", "Error !",MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            currentFrame = grabber.QueryFrame().Resize(400, 350, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
